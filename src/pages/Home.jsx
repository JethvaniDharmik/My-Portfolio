    ...
    <div className="mt-20" id="home">
      <div className="flex justify-between py-10 items-center px-5 lg:px-28 lg:flex-row flex-col-reverse">
        ...
        >
          ...
          >
            I’m a Full Stack Developer passionate about building interactive, user-friendly, and efficient web apps. I specialize in the MERN stack and enjoy turning ideas into production-ready projects with clean code, good UX and fast performance.
          </motion.p>
