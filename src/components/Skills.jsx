...
import { SiBootstrap, SiExpress, SiMysql } from "react-icons/si";
...
export default function Skills() {
  const [skills] = useState([
    ...
    { id: 3, name: "Node.js", icon: <FaNodeJs size={50} /> },
     { id: 4, name: "SQL", icon: <SiMysql size={50} /> },
   ...
   { id: 8, name: "Bootstrap", icon: <SiBootstrap size={50} /> },
  ...
  const [experiences] = useState([
    {
      ...
      description:
        "Developed innovative web solutions for Aarya Softex’s core projects, optimizing website performance and enhancing user experience. Developed innovative web solutions for Aarya Softex’s core projects, optimizing website performance and enhancing user experience. Developed innovative web solutions for Aarya Softex’s core projects, optimizing website performance and enhancing user experience. Developed innovative web solutions for Aarya Softex’s core projects, optimizing website performance and enhancing user experience.",
      logo: "/assets/arya.jpeg",
    },
    {
      id: 2,
      company: "Noble University",
      role: "Social Media Manager",
      period: "Dec 2023 - Feb 2024",
      description:
        "At Noble University, I served as a Social Media Manager, focusing on the creation and implementation of digital marketing strategies to enhance the university’s online presence. By managing content across multiple platforms and analyzing engagement metrics, I contributed to increasing audience reach and improving brand visibility.",
      logo: "/assets/noble.jpeg",
    },
  ]);
